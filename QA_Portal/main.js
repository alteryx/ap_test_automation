...
var _user$project$Portal$featureStatusTableHeader = function (model) {
	return A2(
...
var _user$project$Portal$featureStatusTable = function (string) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
...
var _user$project$Portal$defectStatusTableHeader = function (model) {
	return A2(
		_elm_lang$html$Html$thead,
		{
			ctor: '::',
...
var _user$project$Portal$defectStatusTable = function (string) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
...
var _user$project$Portal$mergedToITBTableHeader = function (model) {
	return A2(
		_elm_lang$html$Html$thead,
		{
			ctor: '::',
...
var _user$project$Portal$mergedToITBTable = function (string) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
...
var _user$project$Portal$readyToMergeTableHeader = function (model) {
	return A2(
		_elm_lang$html$Html$thead,
		{
			ctor: '::',
...
var _user$project$Portal$readyToMergeTable = F2(
...
var _user$project$Portal$searchInput = function (model) {
	return A2(
		_elm_lang$html$Html$input,
		{
			ctor: '::',
...
var _user$project$Portal$banner = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Portal$card = function (statusType) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Portal$navigationListItems = function (string) {
	return A2(
...
var _user$project$Portal$navigation = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						A2(_elm_lang$core$List$map, _user$project$Portal$navigationListItems, model.listOfLinks)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Portal$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SetActive':
...
var _user$project$Portal$encodeResultProjectParentOwner = function (record) {
...
var _user$project$Portal$encodeResultProjectParent = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
								...
								_1: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'Owner',
											_1: _user$project$Portal$encodeResultProjectParentOwner(record.owner)
										},
										_1: {
											ctor: '::',
											_0: {
...
var _user$project$Portal$encodeResultProjectOwner = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Portal$encodeResultProject = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
								...
								_1: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'Owner',
											_1: _user$project$Portal$encodeResultProjectOwner(record.owner)
										},
										_1: {
											ctor: '::',
											_0: {
...
var _user$project$Portal$encodeResultOwner = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Portal$encodeResult = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
										...
										_1: {
											...
											_1: {
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'Owner',
													_1: _user$project$Portal$encodeResultOwner(record.owner)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'Project',
														_1: _user$project$Portal$encodeResultProject(record.project)
													},
													_1: {
														ctor: '::',
														_0: {
...
var _user$project$Portal$encodeUserStory = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
						...
						_1: {
							...
							_1: {
								...
								_0: {
									...
									_0: 'Results',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _user$project$Portal$encodeResult, record.results))
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Portal$encodeParentProjectParentOwner = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Portal$encodeParentProjectParent = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'Owner',
												_1: _user$project$Portal$encodeParentProjectParentOwner(record.owner)
											},
											_1: {
												ctor: '::',
												_0: {
...
var _user$project$Portal$encodeParentProjectOwner = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Portal$encodeParentProject = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
									...
									_1: {
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'Owner',
												_1: _user$project$Portal$encodeParentProjectOwner(record.owner)
											},
											_1: {
												ctor: '::',
												_0: {
...
var _user$project$Portal$encodeParentOwner = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Portal$encodeParent = function (parent) {
	var _p2 = parent;
	if (_p2.ctor === 'Parent') {
		var _p3 = _p2._0;
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: '_rallyAPIMajor',
					_1: _elm_lang$core$Json_Encode$string(_p3.rallyAPIMajor)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: '_rallyAPIMinor',
						_1: _elm_lang$core$Json_Encode$string(_p3.rallyAPIMinor)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: '_ref',
							_1: _elm_lang$core$Json_Encode$string(_p3.ref)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: '_refObjectUUID',
								_1: _elm_lang$core$Json_Encode$string(_p3.refObjectUUID)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: '_objectVersion',
									_1: _elm_lang$core$Json_Encode$string(_p3.objectVersion)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: '_refObjectName',
										_1: _elm_lang$core$Json_Encode$string(_p3.refObjectName)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'Description',
											_1: _elm_lang$core$Json_Encode$string(_p3.description)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'FormattedID',
												_1: _elm_lang$core$Json_Encode$string(_p3.formattedID)
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'DirectChildrenCount',
													_1: _elm_lang$core$Json_Encode$int(_p3.directChildrenCount)
												},
												_1: {
													ctor: '::',
													_0: {
													...
													_1: {
														...
														_0: {
															ctor: '_Tuple2',
															_0: 'Owner',
															_1: _user$project$Portal$encodeParentOwner(_p3.owner)
														},
														_1: {
															ctor: '::',
															_0: {
																ctor: '_Tuple2',
																_0: 'Project',
																_1: _user$project$Portal$encodeParentProject(_p3.project)
															},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: '_type',
																	_1: _elm_lang$core$Json_Encode$string(_p3.rtype)
																},
																_1: {ctor: '[]'}
															}
														}
...
var _user$project$Portal$UserStory = F6(
	function (a, b, c, d, e, f) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, totalResultCount: c, startIndex: d, pageSize: e, results: f};
	});
var _user$project$Portal$userStory = A6(
	_user$project$Portal$UserStory,
	'0',
	'0',
	0,
	0,
	0,
	{ctor: '[]'});
var _user$project$Portal$Result = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, formattedID: g, directChildrenCount: h, name: i, owner: j, project: k, rtype: l};
											};
										};
									};
								};
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ResultOwner))))))));
var _user$project$Portal$ResultProjectOwner = F7(
	function (a, b, c, d, e, f, g) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, rtype: g};
	});
var _user$project$Portal$decodeResultProjectOwner = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ResultProjectOwner))))))));
var _user$project$Portal$ResultProjectParentOwner = F7(
	function (a, b, c, d, e, f, g) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, rtype: g};
	});
var _user$project$Portal$decodeResultProjectParentOwner = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ResultProjectParentOwner))))))));
var _user$project$Portal$ResultProjectParent = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, name: g, owner: h, rtype: i};
	});
var _user$project$Portal$decodeResultProjectParent = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Owner',
		_user$project$Portal$decodeResultProjectParentOwner,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'Name',
			_elm_lang$core$Json_Decode$string,
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'_rallyAPIMajor',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ResultProjectParent))))))))));
var _user$project$Portal$ResultProject = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Portal$decodeResultProject = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Owner',
		_user$project$Portal$decodeResultProjectOwner,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'Name',
			_elm_lang$core$Json_Decode$string,
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'_rallyAPIMajor',
										_elm_lang$core$Json_Decode$string,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ResultProject)))))))))));
var _user$project$Portal$decodeResult = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Project',
		_user$project$Portal$decodeResultProject,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'Owner',
			_user$project$Portal$decodeResultOwner,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'Name',
				_elm_lang$core$Json_Decode$string,
									...
									A3(
										...
										A3(
											...
											A3(
												...
												'_rallyAPIMajor',
												_elm_lang$core$Json_Decode$string,
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$Result)))))))))))));
var _user$project$Portal$decodeUserStory = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Results',
	_elm_lang$core$Json_Decode$list(_user$project$Portal$decodeResult),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'PageSize',
		_elm_lang$core$Json_Decode$int,
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'_rallyAPIMajor',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$UserStory)))))));
var _user$project$Portal$ParentOwner = F7(
	function (a, b, c, d, e, f, g) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, rtype: g};
	});
var _user$project$Portal$decodeParentOwner = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ParentOwner))))))));
var _user$project$Portal$ParentProjectOwner = F7(
	function (a, b, c, d, e, f, g) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, rtype: g};
	});
var _user$project$Portal$decodeParentProjectOwner = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ParentProjectOwner))))))));
var _user$project$Portal$ParentProjectParentOwner = F7(
	function (a, b, c, d, e, f, g) {
		return {rallyAPIMajor: a, rallyAPIMinor: b, ref: c, refObjectUUID: d, objectVersion: e, refObjectName: f, rtype: g};
	});
var _user$project$Portal$decodeParentProjectParentOwner = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'_rallyAPIMajor',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ParentProjectParentOwner))))))));
var _user$project$Portal$ParentProjectParent = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Portal$decodeParentProjectParent = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'owner',
		_user$project$Portal$decodeParentProjectParentOwner,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'_rallyAPIMajor',
										_elm_lang$core$Json_Decode$string,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ParentProjectParent)))))))))));
var _user$project$Portal$ParentProject = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Portal$decodeParentProject = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'owner',
		_user$project$Portal$decodeParentProjectOwner,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'_rallyAPIMajor',
										_elm_lang$core$Json_Decode$string,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$ParentProject)))))))))));
var _user$project$Portal$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {selected: a, tabs: b, cards: c, listOfLinks: d, sortCategory: e, userStory: f, listOfTeams: g, selectedTeam: h};
	});
var _user$project$Portal$model = A8(
	_user$project$Portal$Model,
	'Ready to Merge',
	{
		ctor: '::',
		_0: 'Ready to Merge',
	...
	'');
var _user$project$Portal$init = {ctor: '_Tuple2', _0: _user$project$Portal$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Portal$EmptyParent = {ctor: 'EmptyParent'};
var _user$project$Portal$Parent = function (a) {
	return {ctor: 'Parent', _0: a};
};
var _user$project$Portal$createParent = function (major) {
										...
										return function (owner) {
											return function (project) {
												return function (rtype) {
													return _user$project$Portal$Parent(
														{rallyAPIMajor: major, rallyAPIMinor: minor, ref: ref, refObjectUUID: refId, objectVersion: ver, refObjectName: refName, description: desc, formattedID: format, directChildrenCount: childCount, name: name, owner: owner, project: project, rtype: rtype});
												};
											};
										};
									};
...
var _user$project$Portal$decodeParent = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'project',
		_user$project$Portal$decodeParentProject,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'owner',
			_user$project$Portal$decodeParentOwner,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'name',
				_elm_lang$core$Json_Decode$string,
										...
										A3(
											...
											A3(
												...
												A3(
													...
													'_rallyAPIMajor',
													_elm_lang$core$Json_Decode$string,
													_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Portal$createParent))))))))))))));
var _user$project$Portal$SetSelectedTeam = function (a) {
	return {ctor: 'SetSelectedTeam', _0: a};
};
var _user$project$Portal$selectedTeamDecoder = A2(_elm_lang$core$Json_Decode$map, _user$project$Portal$SetSelectedTeam, _elm_lang$html$Html_Events$targetValue);
var _user$project$Portal$FailedToParseUserStory = function (a) {
	return {ctor: 'FailedToParseUserStory', _0: a};
};
var _user$project$Portal$GetUserStory = function (a) {
	return {ctor: 'GetUserStory', _0: a};
};
var _user$project$Portal$parseGetUserStory = function (jsonString) {
	var _p4 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Portal$decodeUserStory, jsonString);
	if (_p4.ctor === 'Ok') {
		return _user$project$Portal$GetUserStory(_p4._0);
	} else {
		return _user$project$Portal$FailedToParseUserStory(_p4._0);
	}
};
var _user$project$Portal$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:1234/qaportal', _user$project$Portal$parseGetUserStory);
};
var _user$project$Portal$ChooseSortOrder = function (a) {
	return {ctor: 'ChooseSortOrder', _0: a};
};
var _user$project$Portal$SetActive = function (a) {
	return {ctor: 'SetActive', _0: a};
};
var _user$project$Portal$tab = F2(
		...
		return A2(
			_elm_lang$html$Html$span,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Portal$SetActive(tabName)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Portal$tabs = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Portal$tab(model),
			model.tabs));
};
var _user$project$Portal$mergeInfo = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Portal$tabs(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$select,
										{
											...
											_1: {
												ctor: '::',
												_0: _user$project$Portal$onChange(_user$project$Portal$SetSelectedTeam),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$style(
														{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Portal$searchInput(model),
										_1: {ctor: '[]'}
									}
								}
							}),
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$Portal$readyToMergeTableHeader(model),
													_1: {
														ctor: '::',
														_0: A2(
															...
															A2(
																_elm_lang$core$List$map,
																_user$project$Portal$readyToMergeTable(model),
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$Portal$mergedToITBTableHeader(model),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$tbody,
																{ctor: '[]'},
																A2(_elm_lang$core$List$map, _user$project$Portal$mergedToITBTable, model.listOfLinks)),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _user$project$Portal$defectStatusTableHeader(model),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$tbody,
																	{ctor: '[]'},
																	A2(_elm_lang$core$List$map, _user$project$Portal$defectStatusTable, model.listOfLinks)),
																_1: {ctor: '[]'}
															}
														}),
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _user$project$Portal$featureStatusTableHeader(model),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$tbody,
																		{ctor: '[]'},
																		A2(_elm_lang$core$List$map, _user$project$Portal$featureStatusTable, model.listOfLinks)),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {ctor: '[]'}
...
var _user$project$Portal$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Portal$banner(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _user$project$Portal$navigation(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								...
								A2(_elm_lang$core$List$map, _user$project$Portal$card, model.cards)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									...
									{
										ctor: '::',
										_0: _user$project$Portal$mergeInfo(model),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _user$project$Portal$main = _elm_lang$html$Html$program(
	{init: _user$project$Portal$init, view: _user$project$Portal$view, update: _user$project$Portal$update, subscriptions: _user$project$Portal$subscriptions})();
