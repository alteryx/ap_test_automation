...
mergedToITBTableHeader model =
    thead
        ...
        [ tr []
            ...
            , th [ class "tl pa2 pl3 w-10", style [ ( "min-width", "18em" ) ] ]
                [ text "READY FOR CRT"
            ...
            , th [ class "tl pa2 pl3 w-10", style [ ( "min-width", "18em" ) ] ] [ text "TEST STATUS" ]
            , th [ class "tl pa2 pl3 w-10", style [ ( "min-width", "16em" ) ] ] [ text "BLOCKED" ]
